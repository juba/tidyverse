...
Enfin, la fonction `str` renvoit un descriptif plus détaillé de la structure du tableau. Elle liste les différentes variables, indique leur type ^[Les différents types de variables seront décrits plus en détail pendant le chapitre \@ref(vectorfactor) sur les recodages.] et liste les premières valeurs :
