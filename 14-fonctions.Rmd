...
L'ouvrage *R for Data Science* (en anglais), accessible en ligne, contient [un chapitre complet](http://r4ds.had.co.nz/functions.html) d'introduction sur les fonctions.
...
Réordonner, renommer les arguments de la fonction suivante de manière plus adéquate et leur donner une valeur par défaut :
...
Réécrire le code pour obtenir le résultat souhaité.
...
Réécrire le code précédent en utilisant une fonction anonyme (*ie* en définissant la fonction directement dans le `summarise`).
