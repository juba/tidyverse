...
Testons sur une variable du jeu de données `hdv2003`^[Le jeu de données `hdv2003` fait partie de l'extension `questionr`, il est décrit section \@ref(hdv2003).] :
...
On a vu section \@ref(recoder-une-variable-qualitative) qu'on peut recoder l'une de ces variables à l'aide de la fonction `fct_recode()` de l'extension `forcats` :
