...
Il existe d'autres extensions qui font partie du *tidyverse* mais qui doivent être installées et chargées à part, comme par exemple `readxl` (pour l'importation de données depuis des fichiers Excel).
