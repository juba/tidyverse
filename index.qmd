...
Ce document est régulièrement corrigé et mis à jour. La version HTML de référence est disponible [en ligne](https://juba.github.io/tidyverse), et il est téléchargeable aux formats [PDF](https://juba.github.io/tidyverse/introduction_au_tidyverse.pdf) et [EPUB](https://juba.github.io/tidyverse/introduction_au_tidyverse.epub).

Ce document est généré avec [quarto](https://quarto.org/), et son code source est disponible [sur GitHub](https://github.com/juba/tidyverse).
