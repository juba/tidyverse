...
Les vecteurs atomiques sont des structures qui regroupent ensemble plusieurs éléments constitués d'une seule valeur, avec deux contraintes : ces valeurs doivent toutes être du même type. Les vecteurs atomiques ont déjà été introduits section \@ref(vecteurs).
...
L'affichage peut vite devenir illisible quand la liste est plus complexe.
...
### Sélection de lignes et de colonnes {#df-sel}
