...
\iffalse
<div class="solution-exo">
Ça ne fonctionne pas car `lancer_de()` est appelée à chaque itération avec deux arguments : la valeur courante de l'itérateur, et 4. Ainsi dans sa première itération, `map()` exécute `alancer_de(1, 4)`, ce qui génère un message d'erreur puisque `lancer_de()` n'accepte qu'un argument.
</div>
\fi
