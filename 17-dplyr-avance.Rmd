...
Mais on peut faire plus simple. Comme tout argument supplémentaire passé à `across()` est transmis à la fonction appelée, on peut faire :
...
- La deuxième est une syntaxe apparue avec la version 4.1 de R, qui permet de remplacer `function(...)` par le raccourci `\(...)`.
