...
L'affichage des listes peut vite devenir illisible quand la liste est plus complexe^[Pour rappel, la fonction `runif()` renvoie des nombres aléatoires suivant une loi uniforme, par défaut compris entre 0 et 1.].
