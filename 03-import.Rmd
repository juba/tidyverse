...
# Importer et exporter des données (`readr`, `readxl`, `haven`)
...
![Import Dataset](resources/screenshots/import_dataset.png)

Sélectionner *From Text (readr)...*. Une fenêtre s'affiche :

![Import Dialog](resources/screenshots/import_dialog.png)
...
![Import Dialog](resources/screenshots/import_dialog_example.png)
...
![Import Excel](resources/screenshots/import_excel.png)
