...
L'avantage de `dplyr` ici est double :
...
restos <- tibble(
    ...
    style = c("traditionnel", "gastronomique", "traditionnel", "gastronomique", "coiffure"),
    ville = c("Villeurbanne", "Lyon", "Lyon", "Lyon", "Villeurbanne"),
...
On voudrait pouvoir appeler cette fonction de la même manière qu'on utilise `summarise` de manière interactive, mais cela ne fonctionne pas :
