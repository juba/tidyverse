...
`dplyr` est une extension facilitant le traitement et la manipulation de données contenues dans une ou plusiers tables (qu'il s'agisse de *data frame* ou de *tibble*). Elle propose une syntaxe claire et cohérente, sous formes de verbes, pour la plupart des opérations de ce type.
...
Dans ce qui suit on utilisera les données du jeu de données `nycflights13`.
