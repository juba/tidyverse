# Introduction à R : prise en main


*Prérequis :* avoir installé les dernières versions de R et RStudio. Tous deux sont téléchargeables gratuitement pour Wnidows, Mac OS et Linux aux adresses suivantes :

- https://cran.r-project.org/banner.shtml
...
![Démarrage de Rstudio](resources/screenshots/rstudio_start.png)
...
Remarque : les espaces autour des opérateurs n'ont pas d'importance. Les opérations suivantes sont équivalentes. En général on met un espace de chaque côté d'un opérateur pour faciliter la lecture.
