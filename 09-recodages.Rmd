...
## Rappel sur les variables et les vecteurs {#vecteurs}
...
Pour plus d'informations sur les vecteurs et les structures de données de R, vous pouvez vous reporter au chapitre \@ref(structures-donnees).
...
### Modifier les modalités d'une variable qualitative {#recode}
