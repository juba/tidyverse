...
Si on mélange valeurs nombres et valeurs logiques, les `TRUE` sont convertis en `1` et les `FALSE` en `0`.
...
Autre raccourci moins utilisé mais potentiellement pratique, appliquer `mean()` au résultat d'un test donne la proportion de valeurs pour lesquelles le test est vrai.
...
### *data frame* et *tibble* {#data-frame-tibbles}
