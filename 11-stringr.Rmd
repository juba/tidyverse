...
On va utiliser ici les fonctions de l'extension `stringr`. Celle-ci fait partie du *tidyverse*, mais pas de son "coeur". Elle doit donc être installée et chargée explicitement :
