...
- `ifelse` et `if_else` appliquent un test à tous les éléments d'un vecteur et retournent un vecteur dont les éléments dépendent du résultat de chaque test
...
On peut utiliser un `return` pour interrompre l'exécution de la fonction et retourner un résultat. On a en effet vu section \@ref(resfunc) que dès que R rencontre un `return` dans une fonction, il interrompt immédiatement l'exécution de celle-ci.
